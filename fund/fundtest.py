        ...
        for tr in tab.findAll('tr'):
            ...
            if tr.findAll('td') and len((tr.findAll('td')))==7 :
                ...
                try:
                    ...
                    print (self.getCurrentTime(),'fund_nav',str(i)+'/'+str(records),result['fund_code'],result['the_date'],result['nav'],result['add_nav'],result['nav_chg_rate'],result['buy_state'],result['sell_state'])
                except  Exception as e:
